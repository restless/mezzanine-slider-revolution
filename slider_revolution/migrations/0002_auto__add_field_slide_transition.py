...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Slide.transition'
        db.add_column(u'slider_revolution_slide', 'transition',
                      self.gf('mezzanine.core.fields.MultiChoiceField')(default=u'BOXSLIDE', max_length=500),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Slide.transition'
        db.delete_column(u'slider_revolution_slide', 'transition')
