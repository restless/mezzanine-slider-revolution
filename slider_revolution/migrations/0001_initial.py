...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Slider'
        db.create_table(u'slider_revolution_slider', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('page', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'sliders', to=orm['pages.Page'])),
            ('slug', self.gf('django.db.models.fields.SlugField')(max_length=200, null=True, blank=True)),
        ))
        db.send_create_signal(u'slider_revolution', ['Slider'])

        # Adding model 'Slide'
        db.create_table(u'slider_revolution_slide', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('_order', self.gf('django.db.models.fields.IntegerField')(null=True)),
            ('slider', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'slides', to=orm['slider_revolution.Slider'])),
            ('image', self.gf('mezzanine.core.fields.FileField')(max_length=255, null=True, blank=True)),
        ))
        db.send_create_signal(u'slider_revolution', ['Slide'])

        # Adding model 'SlideCaption'
        db.create_table(u'slider_revolution_slidecaption', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('slide', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'captions', to=orm['slider_revolution.Slide'])),
            ('caption', self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True)),
        ))
        db.send_create_signal(u'slider_revolution', ['SlideCaption'])


    def backwards(self, orm):
        # Deleting model 'Slider'
        db.delete_table(u'slider_revolution_slider')

        # Deleting model 'Slide'
        db.delete_table(u'slider_revolution_slide')

        # Deleting model 'SlideCaption'
        db.delete_table(u'slider_revolution_slidecaption')
